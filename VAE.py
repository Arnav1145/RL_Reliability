...
class VAE(tf.keras.Model):
    ...
    def Decoder(self, filters, kernel, stride, neurons) -> tf.keras.Model:
        ...
        x = tf.keras.layers.Dense(self.encoder.get_layer('flattened').output_shape[1], activation='relu', name="latent_layer_image")(latent_inputs)
...
if __name__ == "__main__":
    ...
    n.fit([images, df['NormTime']], epochs=30, batch_size=48)
